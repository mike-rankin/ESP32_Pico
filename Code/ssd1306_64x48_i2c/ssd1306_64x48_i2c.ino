...
// SCL GPIO5
// SDA GPIO4
#define OLED_RESET 4  //ESP32 Pico D4
...
void setup()   {
  ...
  digitalWrite(RED_LED, HIGH);   //Keep not lit
  digitalWrite(GREEN_LED, HIGH); //Keep not lit
  digitalWrite(BLUE_LED, HIGH); //Keep not lit
  ...
  */
  ...
  display.println("ESP32 Pico");
  display.println("");
  display.println("64x48 Oled");
  display.println("");
  display.println("14500 3.7V");
